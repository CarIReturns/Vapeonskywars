...
TextLabel.Text = "Vape On Skywars V2"
TextLabel.TextColor3 = Color3.fromRGB(0, 255, 136)
...
ImageLabel.Image = "rbxassetid://8745364902"
...
Back.BackgroundColor3 = Color3.fromRGB(0, 255, 136)
...
if rawget(GameIds, game.PlaceId) then
    sendNotification("Loading Vape On Skywars" .. GameIds[game.PlaceId][1] .. " ðŸ§¢")
